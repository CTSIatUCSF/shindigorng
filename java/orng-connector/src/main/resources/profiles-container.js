...
"gadgets.features" : {
  ...
  "views" : {
	    "home" : {
	        "isOnlyVisible" : false,
	        "urlTemplate" : "edit/default.aspx?",
	    },
	    "profile" : {
	      "isOnlyVisible" : false,
	      "urlTemplate" : "Profile/Display.aspx?",
  ...
  "opensocial" : {
    ...
    "supportedFields" : {
       "person" : ["id", {"name" : ["familyName", "givenName", "unstructured"]}, "thumbnailUrl", "profileUrl", "email"],
       "activity" : ["appId", "body", "id", "mediaItems", "postedTime", "title", "userId"]
    }
  },
  "osapi.services" : {
